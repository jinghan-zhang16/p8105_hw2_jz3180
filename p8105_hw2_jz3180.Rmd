...
The third dataset unemployment has `r ncol(employment)` columns/variables, and `r nrow(employment)` rows/observations. It gives yearly unemployment data by month from `r min(pull(employment, year))` to `r max(pull(employment, year))`. The actual variables are named `r colnames(employment)`.
